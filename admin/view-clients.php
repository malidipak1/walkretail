			...
			<?php }?>
			  ...
			  while($row_product=mysql_fetch_array($sql))
				...
				?>
                               ...
                               <td width="16%"  bgcolor="#FFFFFF">abc@xyz.com</td>
                                            <td width="16%"  bgcolor="#FFFFFF">
                                                123 456 7890                                          </td>
                                            <td width="8%"  bgcolor="#FFFFFF">Spec</td>
                                            <td width="8%"  bgcolor="#FFFFFF"><a href="clients-profile.php?action=edit&image_id=<?php echo $row_product['header_id']?>&image_name=<?php echo $row_product['team_name']?>"> <img src="images/Edit.gif" width="12" height="12" alt="Edit" border="0" /></a></td>
