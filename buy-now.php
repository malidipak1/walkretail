...
<div class="property-panel-bg"> <span class="property-panel-left">Email Id</span> <span class="poperty-panel-right">
                ...
                <div class="property-panel-bg"> <span class="property-panel-left">Pncode</span> <span class="poperty-panel-right">
                  <input name="email-id" type="text" class="sell2" />
                </span> </div>
        ...
        <div class="property-panel-bg"> 
                  <span class="property-panel-left">Price</span> 
                     <span class="poperty-panel-right">
                    <input name="price" type="text" class="sell2" />
                     </span> 
          </div>
        ...
        <div class="property-panel-bg"> 
                  <span class="property-panel-left">&nbsp;</span> 
                     <span class="poperty-panel-right">
                     <br /><br /><br />
                        <input name="buy-now" type="image" src="images/buy-now.png" />
